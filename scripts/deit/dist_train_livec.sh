...
--output results \
--tensorboard \
--tag full_livec_deit[base]_daclip_v2_diffv3_DIN \
--repeat \
--rnum 10

CUDA_VISIBLE_DEVICES=0,1,2,3 OMP_NUM_THREADS=6 torchrun --nnodes 1 --nproc_per_node 4 --master_port 49949  main.py \
--cfg /home/fubohan/Code/DIQA/configs/deit/deit_livec.yaml \
--data-path /media/hdd1/hzh/iqa-dataset/livec \
--output results \
--tensorboard \
--tag full_livec_deit_daclip_v2_diffv3_DIN_224_1 \
--repeat \
--rnum 10